<?php
namespace Long\DoudianSdk\open\core;



use Long\DoudianSdk\open\api\materialgw\BinaryMaterialUploadAddressAuthParam;
use Long\DoudianSdk\open\api\materialgw\BinaryMaterialUploadAddressAuthRequest;
use Long\DoudianSdk\open\core\http\HttpClient;
use Long\DoudianSdk\open\core\http\HttpRequest;
...
class BinaryMaterialUpload
{
    ...
    public function UploadFile($uploadParams, $accessToken) {
        ...
        $checksumInt = crc32($uploadParams->file_content);
        ...
        $uploadFileReq->body = $uploadParams->file_content;
